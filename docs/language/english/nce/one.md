...
**问句**：[一般疑问句](#lesson-1-2)、[选择疑问句](#lesson-5-6)、[特殊疑问句](#lesson-7-8)、[否定疑问句](#lesson-67-68)、[反意疑问句](#lesson-101-102)

**从句**：[陈述句宾语从句](#lesson-75-76)、[疑问句宾语从句](#lesson-139-140)、[定语从句①](#lesson-121-122)、[定语从句②](#lesson-123-124)、[时间状语从句](#lesson-117-118)、[条件状语从句](#lesson-137-138)

**倒装句**：[so和neither倒装句](#lesson-113-114)

**引语**：[直接引语和间接引语](#lesson-99-100)、[引语的时态和人称变化](#lesson-133-134)、[引语的情态动词变化](#lesson-135-136)

**名词**：[名词复数](#lesson-15-16)、[不可数名词](#lesson-41-42)

**冠词**：[不定冠词a和an](#lesson-5-6)、[定冠词the](#lesson-25-26)

**代词**：[one](#lesson-21-22)、[some和any](#lesson-27-28)、[不定代词](#lesson-115-116)

**动词**：[动词现在分词](#lesson-31-32)、[动词三单](#lesson-49-50)、[动词过去式和过去分词](#lesson-71-72)、[动词不定式](#lesson-87-88)

**形容词**：[形容词变副词](#lesson-73-74)、[比较级和最高级①](#lesson-107-108)、[比较级和最高级②](#lesson-111-112)

**副词**：[too和enough](#lesson-103-104)、[表示频率](#lesson-51-52)

**介词**：[on](#lesson-23-24)、[in](#lesson-25-26)、[at](#lesson-77-78)、[over](#lesson-33-34)、[like](#lesson-53-54)

**情态动词**：[must](#lesson-29-30)、[can](#lesson-43-44)、[may](#lesson-131-132)

**have**：[用法①](#lesson-59-60)、[用法②](#lesson-61-62)、[用法③](#lesson-81-82)、[用法④](#lesson-87-88)

**推测的表达**：[现在的“一定是”与“一定不是”](#lesson-127-128)、[过去的“一定是”与“一定不是”](#lesson-129-130)、[可能may和might](#lesson-131-132)

**固定搭配**：[have got](#lesson-79-80)、[had better](#lesson-95-96)、[have to](#lesson-125-126)、[have gone和have been](#lesson-85-86)

**其他**：[much和many](#lesson-79-80)、[little和few](#lesson-109-110)、[other和another](#lesson-35-36)、[so和because](#lesson-63-64)、[not、no、none之间的关系](#lesson-113-114)、['s缩写](#lesson-83-84)、[时间的表达](#lesson-57-58)、[双宾语](#lesson-23-24)
...
- ①一般情况下直接在词尾加`ly`
  ...
  e.g. `quick` => `quickly`、`pleasant` => `pleasantly`

- ②以辅音字母加`y`结尾

  - 词尾`y`的发音为`/i/`的形容词，变`y`为`i`再加`ly`

    e.g. `happy` => `happily`、`thirsty` => `thirstily`
...
:::danger ⚡本课重点
本节课先主要学习**陈述句做宾语从句**的相关概念和基础知识，往后的[99~100课](#lesson-99-100)和[133~136课](#lesson-133-134)还会巩固学习这方面的知识
...
- **特殊疑问句**：_在一般疑问句的句首加上特殊疑问词并去掉答案_。**`特殊疑问词`+`will/shall`+`主语`+`V.`+`其他`**
  ...
  _先把陈述句中的`will`提到句首，并进行人称调整以符合语义，从而得到一般疑问句，再用`who`对一般疑问句中的答案`me`进行提问，并将其提到句首_
...
- `person`是单数形式，`He is a person.`
- `people`是复数形式，`They are people.`
...
**由`when`、`while`、`just as`引导的时间状语从句**

- **when**：可以引导一般过去时、过去进行时、过去完成时。表示「**当...的时候**」

  - **一般过去时`when`+`V.ed`**：`It was raining very heavily when I got off the train.`
  - **一般过去时`when`+`was/were n./adj.`**：`I had known him when I was a student.`
  - **过去进行时`when`+`was/were V.ing`**：`When I was sleeping my friend phoned me.`
  - **过去完成时`when`+`had V.pp.`**：`They went home when they had spent all their money.`

- **while**：通常只会引导过去进行时，_但也存在一般过去时的可能，只是很少见_。表示「**在...的时候**(_强调两个动作的同时进行_)」

  - **过去进行时`while`+`was/were V.ing`**：`While I was cooking the dinner, he was working in the room.`

- **just as**：引导过去进行时，表示「**正当...的时候**」

  - **过去进行时`just as`+`was/were V.ing`**：`The telephone rang just as I was opening the door.`
...
- **修饰人**：关系代词用 **`who/whom/that`**。**当先行词在从句中作主语时，只能用`who`或`that`；而作宾语时，可以用`who`、`whom`或`that`，甚至省略**。在生活中，实际上人们更多是用`who`
  ...
  **e.g. 他就是昨天打电话给我的那个人**
  ...
  - ②根据分析结果将这句中文拆分成两个部分，`He is the man.` 和 `The man called me yesterday.`
  ...
  **e.g. 他就是我昨天遇到的那个人**
  ...
  - ②根据分析结果将这句中文拆分成两个部分，`He is the man.` 和 `I met the man yesterday.`
...
- **修饰物**：关系代词用 **`which/that`**。**当先行词在从句中作主语或宾语时，可以用`which`或`that`；并且作宾语时甚至还能省略**。在生活中，实际上人们更多是用`which`
  ...
  **e.g. 叼着篮子的那只狗是我的**
  ...
  - ②根据分析结果将这句中文拆分成两个部分，`The dog is mine.` 和 `The dog is carrying the basket.`
  - ③由于先行词 **`the dog`** 在从句中**作主语**，所以关系代词可以用`which`或`that`，且不能省略
  - ④最后得到完整句子 `The dog which/that is carrying the basket is mine.`

  **e.g. 这就是他寄给我的信**

  - ①分析句子可知，从句中「**`他寄给我的`**」修饰限定「**`信`**」
  - ②根据分析结果将这句中文拆分成两个部分，`This is the letter.` 和 `He sent me the letter.`
...
- **修饰人或物**：关系代词用 **`whose/that`**。**当先行词在从句中作定语时，关系代词要用`whose`；当先行词为不定代词或由数词、最高级、`the only`、`the very`、`the same`、`all`所修饰，又或者是以`who`、`what`、`which`开头的疑问句时，关系代词只能用`that`**
  ...
  **e.g. 我朋友的母亲是一名老师**
  ...
  - ②根据分析结果将这句中文拆分成两个部分，`I have a friend.` 和 `His mother is a teacher.`
  ...
  **e.g. 你住的那个小镇叫什么名字**
  ...
  - ②根据分析结果将这句中文拆分成两个部分，`What's the name of the town?` 和 `The town you live in.`
...
- **`that`**：除了适用`who`、`whom`和`which`的规则外，还有自己的特殊规则，例如先行词为不定代词或以`who`、`what`、`which`开头的疑问句，关系代词只能用`that`
  ...
  - `What's the name of the town (that) you live in?`，先行词在从句中作宾语，`that`可以省略
  - `The hospital is around the corner is the one (that) we are going to.`，先行词在从句中作表语，`that`可以省略
...
- **一般现在时**：适用主谓宾结构的一般现在时句式，三单形式也是。助动词分别是`do`和`does`
...
虽然`might`本身是`may`的过去式，但在现代英语使用习惯中，`might`同样能用来对当前或将来状况进行推测，只是其概率比`may`稍低，并且当情况是虚拟的时候只能用`might`。
...
:::danger ⚡本课重点
在之前的[75~76课](#lesson-75-76)和[99~100课](#lesson-99-100)中，主要学习了宾语从句在**主句是一般现在时的用法**，这时候的从句可以是任何时态
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td rowspan="3">引号内第二人称变间接引语后，<b>与主句宾语的人称保持一致，如果主句没有宾语，则可以用第一人称</b></td>
      <td rowspan="3">一般现在时</td>
      <td>can</td>
...
:::danger ⚡本课重点
在之前的[75~76课](#lesson-75-76)、[99~100课](#lesson-99-100)和[133~136课](#lesson-133-134)中所学的宾语从句全部都是**陈述句做宾语从句**，本节课将会学习**疑问句做宾语从句**的相关知识
...
**一般疑问句宾语从句**：由 **`if`引导的陈述语序**的一般疑问句作宾语从句，其结构为 **`主句`+`if`+`宾从(一般疑问句)`**
...
- ③给主句添加连接词`if`用来引导第二步的陈述语序：`I want to know if she is a teacher.`

---

- ①一般疑问句：`Does she often go shopping?`
- ②把一般疑问句转为陈述语序：`she often goes shopping`
- ③给主句添加连接词`if`用来引导第二步的陈述语序：`I want to know if she often goes shopping.`

---

- ①一般疑问句：`Have you lost your key?`
- ②把一般疑问句转为陈述语序：`you have lost your key`
- ③给主句添加连接词`if`用来引导第二步的陈述语序：`I want to know if you have lost your key.`

---

- ①一般疑问句：`Will you go to school tomorrow?`
- ②把一般疑问句转为陈述语序：`you will go to school tomorrow`
- ③给主句添加连接词`if`用来引导第二步的陈述语序：`I want to know if you will go to school tomorrow.`
...
- **特殊疑问句**：_在一般疑问句的句首加上特殊疑问词并去掉答案_。**`特殊疑问词`+`be`+`主语`+`V.pp.`(+`其他`)**
  ...
  _先把陈述句中的`be`动词提到句首得到一般疑问句，再用`where`对一般疑问句中的答案`in China`进行提问，并将其提到句首_
